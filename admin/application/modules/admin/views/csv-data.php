      ...
      <div class="row">
        <div class="col-md-4">
          <h1 class="text-uppercase"> 
              <i class="fa fa-users"></i> CSV DATA
          </h1>
        </div>
                          ...
                          ?>
                            ...
                            <tr class="">
                                ...
                                <td>
                                 ...
                                 <!--<td></td>-->
                                 <td>
                                            <?php echo ucwords($csv_data->created_on);?>
                                  
                                </td>
                                
                                    <td>
                                        <?php
                                            if(empty($csv_data->company_code)){
                                                $code = 0;
                                            }else{
                                                $code = $csv_data->company_code;
                                            }
                                        ?>
                                        
                                  <a href="<?php echo base_url('admin/view-CSV-Data/').$code.'/'.$csv_data->id;?>"><button data-id="<?php echo $csv_data->id; ?>" class="btn btn-primary btn-block" ><i class="fa fa-pen"></i> VIEW</button>
                                </td>
                                     <?php 
                                    $jsondata = json_decode($csv_data->data);
                                    // print_r($jsondata);
 ...
 <script type="text/javascript">
  ...
  $('#company_code').change(function(){
        ...
        if(company_code != ''){
            ...
            window.location.href ='<?php echo base_url('admin/CSV-Data/')?>'+company_code;
        }else{
            window.location.href = '<?php echo base_url('admin/CSV-Data')?>';
        }
