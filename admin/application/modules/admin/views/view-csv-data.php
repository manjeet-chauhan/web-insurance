      ...
      <div class="row">
        <div class="col-md-4">
          <h1 class="text-uppercase"> 
              <i class="fa fa-users"></i> CSV DATA - (<?=$company_code_id?>)
          </h1>
        </div>
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr>
                            <?php 
                            if(!empty($csv_datas)){
                                $csv_title = json_decode($csv_datas->data);
                                
                            
                                 foreach($csv_title[0] as $key=>$csv_t){
                                    echo "<th>".$key."</th>";
                                }
                            ?>
                      ...
                      <tbody>
                          ...
                          <?php 
                            ...
                            foreach ($csv_title as $json_csv_datas) {
                                //  print_r($json_csv_datas);
                                echo "<tr>";    
                                foreach ($json_csv_datas as $csv_data) {
