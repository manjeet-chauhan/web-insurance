      ...
      <div class="row">
        <div class="col-md-8">
          <h1 class="text-uppercase"> 
              <i class="fa fa-users"></i> Page Setting
          </h1>
        </div>
        <div class="col-md-4">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="contents">
            <div class="row">
              <div class="col-md-12">
                  <form action="<?php echo base_url('admin/save-page-setting')?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        
                        <?php
                        if($this->session->userdata('msg')){
                          echo ' <div class="alert alert-danger" role="alert">'.$this->session->userdata('msg').'<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    ...
                    <textarea class="form-control" id="main_title" name="main_title" aria-describedby="emailHelp" placeholder="Enter Main Title of Page"><?php echo $csv_datas->main_title?></textarea>
                  </div> 
                  </div>
                     ...
                     <div class="col-md-12">
                            <div class="form-group">
                    <label for="title_1">First Section Title</label>
                    <input type="text" class="form-control" id="title_1" name="title_1" aria-describedby="emailHelp" placeholder="Enter First Title" value="<?php echo $csv_datas->title_1?>">
                  </div> 
                  </div>

                  <div class="col-md-12">
                            <div class="form-group">
                    <label for="desc_1">First Section Description</label>
                    <textarea class="form-control" id="desc_1" name="desc_1" aria-describedby="emailHelp" placeholder="Enter Description of First Section"><?php echo $csv_datas->desc_1?></textarea>
                  </div> 
                  </div>
                ...
                <div class="col-md-12">
                            <div class="form-group">
                    <label for="title_2">Second Section Title</label>
                    <input type="text" class="form-control" id="title_2" name="title_2" value="<?php echo $csv_datas->title_2?>" aria-describedby="emailHelp" placeholder="Enter Second Title">
                  </div> 
                  </div>

                  <div class="col-md-12">
                            <div class="form-group">
                    <label for="desc_2">Second Section Description</label>
                    <textarea class="form-control" id="desc_2" name="desc_2" aria-describedby="emailHelp" placeholder="Enter Description of Second Section"><?php echo $csv_datas->desc_2?></textarea>
                  </div> 
                  </div>
              ...
              <div class="col-md-12">
                          <div class="form-group">
                    <label for="title_3">Third Section Title</label>
                    <input type="text" class="form-control" id="title_3" name="title_3" aria-describedby="emailHelp" placeholder="Enter Third Title" value="<?php echo $csv_datas->title_3?>">
                  </div> 
                  </div>

                  <div class="col-md-12">
                            <div class="form-group">
                    <label for="desc_3">Third Section Description</label>
                    <textarea class="form-control" id="desc_3" name="desc_3" aria-describedby="emailHelp" placeholder="Enter Description of Third Section"><?php echo $csv_datas->desc_3?></textarea>
                  </div> 
                  </div>
                    ...
                    <input type="file" class="form-control" id="banner" name="banner" aria-describedby="emailHelp" placeholder="Enter Third Title">
                  </div> 
                  </div>
                  <img src="<?php echo base_url('assets/admin/images/').$csv_datas->banner;?>" width="400px" height="200px">
