  ...
  <head>
    ...
    <style type="text/css">
      .pgbackground {
          ...
          background-image: url('<?php echo base_url('assets/admin/images/insurance-background.jpg'); ?>');
                ...
                <div class="registercont card">
                  <form class="login-form" id="formLogin" name="formLogin">
                    ...
                    <div class="imgcont text-center">
                      <!-- <img style="border: 1px solid #ccc;" src="<?php echo $vendorimages ?>logo.png"> -->
                      <!--<img src="<?php echo  base_url('assets/frontend/images/logo.png'); ?>" style="height: 80px; " alt="logo">-->
                       <div class="textlogo">INSURANCE</div> 
