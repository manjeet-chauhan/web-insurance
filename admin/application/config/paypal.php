...
$config['APIUsername'] = $config['Sandbox'] ? 'service-facilitator_api1.fruitastic.com.au' : 'trippedswitches_api1.gmail.com';

$config['APIPassword'] = $config['Sandbox'] ? '3TWZ4CZE55SQZ6LG' : 'MWTN7RAKEC2K8759';

$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AmKBTv9VO0vo02nipMM6FUkLd6uX' : 'Ag4Z26aBAOzaklnCwFn6P2MOkXJRA9b1-zoATQbgxLF7AjdhcDDrBcDr';
...
$config['DeveloperEmailAccount'] = 'service-facilitator@fruitastic.com.au';
